...
export default function ProductDetailPage() {
  ...
  const product = {
    ...
    category: "Сандал",
    description:
      "Дээд зэргийн тухлаг, загварлаг сандал. Таны гэрт орчин үеийн уур амьсгал оруулна.",
    origin: "Швед (IKEA)",
    baseRating: 4.8,
    reviewsCount: 124,
  };
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-zinc-400 hover:text-black mb-10 transition-all group"
        >
          <ArrowLeft
            size={20}
            ...
            <button
              ...
              className={`absolute top-8 right-8 p-4 rounded-full shadow-lg transition-all active:scale-90 ${
                isLiked
                  ...
                  : "bg-white text-zinc-400 hover:text-red-400"
              }`}
            >
              <Heart
                size={28}
            ...
            <div className="flex items-center gap-6 mb-8 p-4 bg-zinc-50 rounded-2xl w-fit">
              ...
              <div className="text-sm font-medium text-zinc-500">
                ...
                <p className="text-[10px] uppercase tracking-wider">
                  {product.reviewsCount} хүн үзсэн
                </p>
              </div>
            </div>
