  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in duration-300">
        <button
          onClick={onClose}
          className="absolute right-6 top-6 p-2 hover:bg-zinc-100 rounded-full z-10 transition-colors"
        >
          <X size={24} />
        </button>
        ...
        <div className="md:w-1/2 p-10 flex flex-col justify-center">
          <span className="text-zinc-400 uppercase tracking-[0.2em] text-xs font-bold mb-3">
            {product.category}
          </span>
